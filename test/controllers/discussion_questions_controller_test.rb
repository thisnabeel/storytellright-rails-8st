...
class DiscussionQuestionsControllerTest < ActionController::TestCase
  ...
  test "should create discussion_question" do
    assert_difference('DiscussionQuestion.count') do
      post :create, discussion_question: { body: @discussion_question.body, discussion_id: @discussion_question.discussion_id, position: @discussion_question.position }
    end
  ...
  test "should update discussion_question" do
    patch :update, id: @discussion_question, discussion_question: { body: @discussion_question.body, discussion_id: @discussion_question.discussion_id, position: @discussion_question.position }
    assert_redirected_to discussion_question_path(assigns(:discussion_question))
  end
