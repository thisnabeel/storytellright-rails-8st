...
class EssaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create essay" do
    assert_difference('Essay.count') do
      post essays_url, params: { essay: { body: @essay.body, essay_id: @essay.essay_id, position: @essay.position, title: @essay.title } }
    end
  ...
  test "should update essay" do
    patch essay_url(@essay), params: { essay: { body: @essay.body, essay_id: @essay.essay_id, position: @essay.position, title: @essay.title } }
